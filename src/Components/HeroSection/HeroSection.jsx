    ...
    <>
        ...
        <div className="px-30px]  py-[40px] flex flex-col items-center gap-[40px]">
          <div className="pt-6 pb-[209px] relative  ">
            ...
            <div className="relative text-[#000] grid text-center grid-cols-1 px-[30px] py-[30px] gap-[24px]">
              ...
              <p className=" text-[#000] font-[Inter] leading-[24px] normal-case text-[16px] font-normal ">
      ...
      <div className="hidden lg:block lg:w-full">
        <div className="  mx-auto flex flex-col  items-center gap-[40px]">
          ...
          >
            <div className="mx-auto  flex flex-col gap-[24px] text-[#000] text-center   ">
              <h1 className="  lg:text-[62px]  text-[#000]  font-Ubuntu  text-[32px] normal-case font-bold leading-normal  ">
                MULTI-PUROPSE TACTICAL VEHICLES SUPERIOR 4X4
              </h1>
              <p className=" text-[#000] font-[Inter] leading-[24px] normal-case text-[16px] font-normal ">
                ONE TEAM ONE GOAL SAVING LIVES...
              ...
              <button
                type="btn"
                className=" text-[#fff] bg-[#205228] mx-auto justify-center items-center py-[12px] px-[40px] gap-[8px] rounded-[4px]"
              >
                Contact
              </button>
            </div>
