...
const Navbar = () => {
  ...
  return (
    <div div className="fixed w-full z-20 top-[0px] bg-[#155214] ">
      <div className="max-w-[1512px] mx-auto">
        <div className="hidden py-[6px] w-full px-[80px] lg:inline-flex justify-end items-start  text-[#fff] gap-[24px]">
        ...
        <div className="bg-[#fff]">
          <navbar className=" max-w-[1512px] h-[80px] w-full  bg-[#fff] grid grid-cols-1 px-[40px] mx-auto">
